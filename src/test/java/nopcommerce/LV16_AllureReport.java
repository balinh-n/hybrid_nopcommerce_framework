...
public class LV16_AllureReport extends BaseTest {
    ...
    // registerPage.inputConfirmPassword("abcd1234");
    // registerPage.clickRegisterButton();
    // verifyEquals("The password and confirmation password do not match.",
    ...
    // registerPage.clickRegisterButton();
    // verifyEquals(
    // "Password must meet the following rules: must have at least 6 characters and
    ...
    // registerPage.inputConfirmPassword("abcd1234@");
    // registerPage.clickRegisterButton();
    // verifyEquals("The specified email already exists.",
    // registerPage.getEmailValidation());
    // }
    ...
    // registerPage.inputConfirmPassword("abcd1234@");
    // registerPage.clickRegisterButton();
    // verifyEquals("Your registration completed.",
    // registerPage.getRegisterMessage().trim());
